<template>
    <!-- <h3>지출 금액 top3</h3>
    <div>
        <h2 v-for="(item, index) in sortedData.slice(0, 3)" :key="index">
            {{ item.category }} {{ item.count }}건 {{ item.amount }} 
            <hr>
        </h2>
    </div> -->

    <div>
        <h5 class="mb-4">지출 금액 TOP 3</h5>
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            return { sortedData, iconObj, formatAmount, getImagePath };
        }
    };
</script>
